...
public class AnagrTest {
	...
	public void setUp() {
		 ...
		 */
		AnagrMapper mapper = new AnagrMapper();
		mapDriver = new MapDriver<Object, Text, Text, Text>();
		mapDriver.setMapper(mapper);
		/*
		 * Set up the reducer test harness.
		 */
		AnagrReducer reducer = new AnagrReducer();
...
*/
	...
	public void testMapReduce() throws IOException {
		...
		//mapReduceDriver.addInput(new Pair<Object, Text>("2", new Text("teach\nthe\nmap\nand\nreduce\nclass\nis\nfun")));
